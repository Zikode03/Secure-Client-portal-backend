...
{
    public const long MaxUploadFileSizeBytes = 100_000_000;
    ...
    public static void ValidateUpload(UploadDocumentRequest request)
    {
        ...
        if (request.File is not null)
        {
            ...
            {
                errors.Add("File exceeds the maximum upload size of 100 MB.");
            }
            ...
            {
                errors.Add("Unsupported file type. Allowed file types: .pdf, .png, .jpg, .jpeg, .doc, .docx, .xls, .xlsx.");
            }
        }
