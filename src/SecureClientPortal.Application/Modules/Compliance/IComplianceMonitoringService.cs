...
public interface IComplianceMonitoringService
{
    ...
    Task<ServiceResult<ComplianceMonitoringResponse>> VerifyCipcAsync(Guid clientId, RunAuthorityVerificationRequest request, ClaimsPrincipal user, CancellationToken ct);
