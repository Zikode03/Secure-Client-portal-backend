...
using SecureClientPortal.Backend.Application.Contracts.Modules.Assignments;
...
namespace SecureClientPortal.Backend.Infrastructure.Modules.Assignments.Application;
